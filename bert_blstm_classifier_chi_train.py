from kashgari.corpus import SMP2017ECDTClassificationCorpus, TencentDingdangSLUCorpus
...
def main():
    ...
    validate_x, validate_y = SMP2017ECDTClassificationCorpus.get_classification_data('validate')
    test_x, test_y = SMP2017ECDTClassificationCorpus.get_classification_data('test')
